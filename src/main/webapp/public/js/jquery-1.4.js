...
function blockui(setting){
    ...
    var _scrollHeight = document.documentElement.clientHeight+Math.max(document.body.scrollHeight, document.documentElement.scrollHeight)
    ...
    return function(){
        document.body.removeChild(newMask);//取消遮蔽层
    }
}

/**
 * 表单产生submit事件时弹出一个遮蔽层，并设置1秒后自动取消遮蔽层
 * @author RobotJi
 * @date 2011-07-12
 */
$(document).ready(function(){
	$("form").bind("submit", function() {
        ...
        setTimeout(function(){block()},1000);//1秒后自动取消遮蔽层
	});
