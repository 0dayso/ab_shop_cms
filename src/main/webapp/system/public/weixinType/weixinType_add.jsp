...
<html>
	<head>
		...
		<title>增加微信回复格式</title>
	</head>
	<body>
		<div class="headerPart">
  			<img class="imgAll" src="<%=request.getContextPath() %>/public/images/tubiao-01.png"/>
  			<span><font class="font1">当前位置:</font><font class="menuName_1">回复管理-添加回复格式&nbsp;&nbsp;&nbsp;&nbsp;(带<font color="red">*</font>的为必填项)</font></span>
        </div>
    	<div class="main">
		<s:form action="weixinType_add" method="post" theme="simple" namespace="/system" onsubmit="return validate()">
			<table class="tableborder" border="1" bordercolor="#dbdbdb">
				<tr>
					<td class="th1">回复格式编码:</td>
					<td align="left"><s:textfield id="code" name="code" ></s:textfield></td>
					<td class="th1">回复格式名称:</td>
					<td align="left"><s:textfield id="name" name="name" ></s:textfield></span></td>
				</tr>
			</table>
