...
<html>
	<head>
		...
		<script type="text/javascript">
			function del(id){
				if(confirm("确定删除吗?")){
					window.self.location='event_delete.action?id='+id;
				}
			}
		</script>
	</head>
	<body>
		<div style="height:30px;">
   			<img src="<%=request.getContextPath() %>/public/images/tubiao-01.png"/><span><font class="font1">当前位置:</font><font color="#085370">微信事件管理</font></span>
    	</div>
    	<div class="title">
    		<span style="padding:3px;height:26px;line-height:26px;">查询事件</span>
    	</div>
    	<div class="main">
			<s:form action="event_search" theme="simple" method="post" namespace="/system">
					...
					<tr>
						...
						<td colspan="2" align="left">
							<input type="button" value="" class="add_btn" onmousemove="this.className='add_btn1'" onmouseout="this.className='add_btn'"
								onclick="javascript:window.location.href='<%=basePath%>/system/event/event_view.action'" />
							</div>
						</td>
					</tr>
				</table>
					...
					<tr class="th">
						...
						<s:else>
							...
							<s:if test="pageList != null && pageList.size>0">
								<tr class="pageTr">
									<td colspan="10">
										<s:url id="url_pre" value="weixinMenu_search.action">
											<s:param name="pageIndex" value="pageIndex-1"></s:param>
											<s:param name="name" value="name"></s:param>
											<s:param name="code" value="code"></s:param>
										</s:url>
										<s:url id="url_next" value="weixinMenu_search.action">
											<s:param name="pageIndex" value="pageIndex+1"></s:param>
											<s:param name="name" value="name"></s:param>
											<s:param name="code" value="code"></s:param>
										</s:url>
										<s:url id="url_first" value="weixinMenu_search.action">
											<s:param name="pageIndex" value="1"></s:param>
											<s:param name="name" value="name"></s:param>
											<s:param name="code" value="code"></s:param>
										</s:url>
										<s:url id="url_last" value="weixinMenu_search.action">
