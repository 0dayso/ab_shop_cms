...
public class ReflectionUtils {
	...
	public static Class getSuperClassGenricType(final Class clazz,
		...
		logger.debug("clazz.getGenericSuperclass() = {} & {}", genType, genType.getClass().getName());
		...
		logger.debug("((ParameterizedType) genType).getActualTypeArguments()[0] = {} & {}",
						params[index], params[index].getClass().getName());
	 ...
	 * @date 2010-01-20
	 */
	public static <T> String[] getAllAccessableFieldNames(Class<T> clazz)
		...
		for (Field field : declaredFields) {
			...
			String isMethodName = "is"
					+ StringUtils.capitalize(field.getName());
			if (clazz.getMethod(setterMethodName) != null
					&& (clazz.getMethod(getterMethodName) != null || clazz
							.getMethod(isMethodName) != null)) {
				names.add(field.getName());
				logger.debug("Class {} Detected attribute:{}", clazz
	...
	public static Object invokeMethod(Class clazz,String methodName){
		try {
			...
			m.invoke(clazz.newInstance(), "345");
